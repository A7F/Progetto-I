...
public class DatabaseStrings{
    ...
    public static final String createTavoli = "CREATE TABLE IF NOT EXISTS Tavoli(NUMTAVOLO int NOT NULL, PRENOTATO BOOLEAN DEFAULT 0, PRENOTAZIONE int NOT NULL ON DELETE CASCADE, PRIMARY KEY(PRENOTAZIONE));";
    public static final String createPrenotazioni = "CREATE TABLE IF NOT EXISTS Prenotazioni(PRENOTAZIONE int NOT NULL,NOME VARCHAR(20) DEFAULT NULL,ORE DATE DEFAULT NULL, FOREIGN KEY(PRENOTAZIONE) REFERENCES Tavoli(PRENOTAZIONE));";
}
