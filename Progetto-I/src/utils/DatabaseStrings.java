...
public class DatabaseStrings{
    ...
    public static final String createTavoli = "CREATE TABLE IF NOT EXISTS Tavoli(NUMTAVOLO int NOT NULL, PRENOTATO BOOLEAN DEFAULT 0, PRENOTAZIONE int NOT NULL AUTO_INCREMENT);";
