...
public class DatabaseStrings{
    ...
    public static final String createPrenotazioni = "CREATE TABLE IF NOT EXISTS Prenotazioni(PRENOTAZIONE int DEFAULT NULL,NOME VARCHAR(20) DEFAULT NULL, ORE DATE DEFAULT NULL);";
