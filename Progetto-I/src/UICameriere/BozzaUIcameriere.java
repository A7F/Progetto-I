 ...
 * @author Luca
 */
public class BozzaUIcameriere extends javax.swing.JFrame {

    /**
     * Creates new form BozzaUIcameriere
     */
    public BozzaUIcameriere() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BozzaUIcameriere.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BozzaUIcameriere().setVisible(true);
            }
        });
    }
