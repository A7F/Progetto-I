...
/**
 * questa classe è il modello della table impiegati ovvero prende i dati dal database e ne costruisce una jtable.
 * imposta anche le proprietà del modello stesso. E' stato scelto un rowset invece che un resultset perchè il
 * rowset permette cambiamenti a runtime, notificando gli altri componenti di avvenuto cambiamento.
 * Sostanzialmente si comporta come un listmodel, contrariamente al resultset che è statico.
 * @author Luca
 */
public class ImpiegatiTableModel implements TableModel{
    final CachedRowSet impiegatiRowSet; //contiene il contenuto della table impiegati SQL
    private final ResultSetMetaData metadata;
    int numcols,numrows;
    
    
    
    public ImpiegatiTableModel(CachedRowSet rowSetArg) throws SQLException{
